...
bool Device::is_device_suitable(VkPhysicalDevice physicalDevice) {
...
void Device::create_logical_device(bool enableValidationLayers, std::vector<const char*> validationLayers) {
